...
{[Area("Admin")]
    public class UserController : Controller
    {
        ...
        public IActionResult DeleteUser(int Id)
        {
            // ViewData["id"] = Id;
            WeeeebContext context = HttpContext.RequestServices.GetService(typeof(Weeeb.Models.WeeeebContext)) as WeeeebContext;
            int count2 = context.XoaUserOrdIn(Id);
            int count1 = context.XoaUserOrd(Id);
        ...
        {
            WeeeebContext context = HttpContext.RequestServices.GetService(typeof(Weeeb.Models.WeeeebContext)) as WeeeebContext;
            ViewBag.demdon = context.CountOrderU(Id);
            ViewBag.tong = context.CountTongOU(Id);
            return View(context.GetOrdByMaUser(Id));
        }
        public IActionResult UserItems(int Id)
        {
            WeeeebContext context = HttpContext.RequestServices.GetService(typeof(Weeeb.Models.WeeeebContext)) as WeeeebContext;
